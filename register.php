            ...
            <form id="formAuthentication" class="mb-3" action="" method="POST">
              <div class="mb-3 Input">
                ...
                <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Enter your First Name"
                  autofocus value= <?php if (isset($_POST['firstname'])){ echo $_POST['firstname']; }?> >
                  <small>Error Message</small>
              </div>
              <div class="mb-3 Input">
                <label for="lastname" class="form-label">Last Name</label>
                <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Enter your Last Name"
                  autofocus value= <?php if (isset($_POST['lastname'])){ echo $_POST['lastname']; }?> >
                  <small>Error Message</small>
              </div>
              <div class="mb-3 Input">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control  <?php if(isset($_SESSION['error'])) { echo " is-invalid";}?>" id="email" name="email" placeholder="Enter your email" autofocus value= <?php if (isset($_POST['email'])){ echo $_POST['email']; }?> >
                <small>Error Message</small>
                <?php if(isset($_SESSION['error'])) {echo "<small style='display:block';>{$_SESSION['error']}</small>";} ?>
              </div>
              <div class="mb-3 form-password-toggle Input">
                ...
                <div class="input-group input-group-merge">
                  <input type="password" id="password" class="form-control" name="password"
                    placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;"
                    aria-describedby="password" value= <?php if (isset($_POST['password'])){ echo $_POST['password']; }?> >
